...
void E57<PointCloud>::findMaxMin(PointCloud &pointcloud, StructMaxMin *vector)
{
...
template <typename PointCloud>
int E57<PointCloud>::openE57(const std::string &filename, PointCloud &pointcloud, float &scale_factor, int64_t &scanCount, Eigen::Matrix4f &mat4, int64_t scanIndex)
{
    try
    {
...
template <typename PointCloud>
int E57<PointCloud>::saveE57File(const std::string &filename, PointCloud &cloud, float &scale_factor, int index)
{
    try
    {
...
template class E57<pcl::PointCloud<pcl::PointXYZI>::Ptr>;
template class E57<pcl::PointCloud<pcl::PointXYZRGB>::Ptr>;